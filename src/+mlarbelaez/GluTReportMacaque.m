classdef GluTReportMacaque  
    ...
    methods %% GET 
        ...
        function g = get.GluTxlsxInfo(this)
            switch (this.mode)
                case 'Macaque'                    
                    g = this.gluTxlsx.pid_map(this.pnum).(this.region);
                case 'WholeBrain'
        ...
        function s = get.pnum(this)
            s = this.kmps.pnumber;
        end
        function s = get.snum(this)
            s = this.kmps.scanIndex;
        end
 		...
 		function this = GluTReportMacaque(ks, kmps) 
            ...
            if (~isempty(this.ks))
                try
                    ...
                    this.K12      = this.ks(this.ik12frac)*this.K21;
